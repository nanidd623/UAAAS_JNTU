...
namespace UAAAS.Models
{
    ...
    public partial class jntuh_college_land
    {
        ...
        public string landregistrationdocument { get; set; }
        public string landconversiondocument { get; set; }
