...
{
    [ErrorHandling]
    public class PA_CollegeInformationController : BaseController
    {
        ...
        public ActionResult Create(string collegeId)
        {
            ...
            //if(false)
            {
                return RedirectToAction("View", "PA_CollegeInformation");
            }
            if (userCollegeID > 0 && (Roles.IsUserInRole("Admin") || Roles.IsUserInRole("DataEntry")))
            {
                return RedirectToAction("Edit", "PA_CollegeInformation", new { collegeId = Utilities.EncryptString(userCollegeID.ToString(), WebConfigurationManager.AppSettings["CryptoKey"]).ToString() });
            }
        ...
        private void SaveCollegeInformation(CollegeInformation collegeInformation)
        {
            ...
            else
            {
                ...
                jntuh_college.formercollegename = collegeInformation.formerCollegeName;
                    ...
                    if (collegeInformation.collegestatusfile != null || collegeInformation.collegestatusfilepath != null)
                    {
                        ...
                        if (collegeInformation.collegestatusfile != null)
                        {
                            ...
                            if (ext.ToUpper().Equals(".PDF") || ext.ToUpper().Equals(".PDF"))
                            {
                                ...
                                {
                                    collegeInformation.collegestatusfile.SaveAs(string.Format("{0}/{1}", Server.MapPath(collegestatusfilepath), collegeInformation.collegestatusfilepath));
                ...
                if (collegeID != 0)
                {
                    ...
                    var jntuh_college_establishment = db.jntuh_college_establishment.Where(ce => ce.collegeId == collegeID).FirstOrDefault();


                    if (jntuh_college_establishment == null)
                    {
                        jntuh_college_establishment collegeEstablishmentDetails = new jntuh_college_establishment();
                        collegeEstablishmentDetails.instituteEstablishedYear = collegeInformation.instituteEstablishedYear;
                        if (collegeInformation.firstApprovalDateByAICTE != null)
                        {
                            collegeEstablishmentDetails.firstApprovalDateByAICTE = Utilities.DDMMYY2MMDDYY(collegeInformation.firstApprovalDateByAICTE);
                        }
                        else
                        {
                        ...
                        if (collegeInformation.FirstApprovalDateByAICTEDoc != null)
                        {
                            string approvalDateByAICTEfile = "~/Content/Upload/College/ApprovalDateByAICTE";
                            if (!Directory.Exists(Server.MapPath(approvalDateByAICTEfile)))
                            {
                                Directory.CreateDirectory(Server.MapPath(approvalDateByAICTEfile));
                            }
                            var ext = Path.GetExtension(collegeInformation.FirstApprovalDateByAICTEDoc.FileName);
                            if (ext.ToUpper().Equals(".PDF") || ext.ToUpper().Equals(".PDF"))
                            {
                                if (collegeInformation.FirstApprovalDateByAICTEDocPath == null)
                                {
                                    string fileName = collegeCode + "-" + DateTime.Now.ToString("yyyyMMdd-HHmmssffffff") + "-" + "JNTUH";
                                    collegeInformation.FirstApprovalDateByAICTEDoc.SaveAs(string.Format("{0}/{1}{2}", Server.MapPath(approvalDateByAICTEfile), fileName, ext));
                                    collegeInformation.FirstApprovalDateByAICTEDocPath = string.Format("{0}{1}", fileName, ext);
                                    collegeEstablishmentDetails.firstApprovalDateByAICTEdoc = collegeInformation.FirstApprovalDateByAICTEDocPath;
                                }
                                else
                                {
                                    collegeInformation.FirstApprovalDateByAICTEDoc.SaveAs(string.Format("{0}/{1}", Server.MapPath(approvalDateByAICTEfile), collegeInformation.FirstApprovalDateByAICTEDocPath));
                                    collegeEstablishmentDetails.firstApprovalDateByAICTEdoc = collegeInformation.FirstApprovalDateByAICTEDocPath;
                                }
                            }
                        }
                        ...
                        if (collegeInformation.firstAffiliationDateByJNTU != null)
                        {
                            collegeEstablishmentDetails.firstAffiliationDateByJNTU = Utilities.DDMMYY2MMDDYY(collegeInformation.firstAffiliationDateByJNTU);
                        }
                        else
                        {
                            collegeInformation.firstAffiliationDateByJNTU = null;
                        }

                        if (collegeInformation.FirstAffiliationDateByJNTUDoc != null)
                        {
                            string affiliationDateByJNTU = "~/Content/Upload/College/AffiliationDateByJNTU";
                            if (!Directory.Exists(Server.MapPath(affiliationDateByJNTU)))
                            {
                                Directory.CreateDirectory(Server.MapPath(affiliationDateByJNTU));
                            }
                            var ext = Path.GetExtension(collegeInformation.FirstAffiliationDateByJNTUDoc.FileName);
                            if (ext.ToUpper().Equals(".PDF") || ext.ToUpper().Equals(".PDF"))
                            {
                                if (collegeInformation.FirstAffiliationDateByJNTUDocPath == null)
                                {
                                    string fileName = collegeCode + "-" + DateTime.Now.ToString("yyyyMMdd-HHmmssffffff") + "-" + "JNTUH";
                                    collegeInformation.FirstAffiliationDateByJNTUDoc.SaveAs(string.Format("{0}/{1}{2}", Server.MapPath(affiliationDateByJNTU), fileName, ext));
                                    collegeInformation.FirstAffiliationDateByJNTUDocPath = string.Format("{0}{1}", fileName, ext);
                                    collegeEstablishmentDetails.firstAffiliationDateByJNTUdoc = collegeInformation.FirstAffiliationDateByJNTUDocPath;
                                }
                                else
                                {
                                    collegeInformation.FirstAffiliationDateByJNTUDoc.SaveAs(string.Format("{0}/{1}", Server.MapPath(affiliationDateByJNTU), collegeInformation.FirstAffiliationDateByJNTUDocPath));
                                    collegeEstablishmentDetails.firstAffiliationDateByJNTUdoc = collegeInformation.FirstAffiliationDateByJNTUDocPath;
                                }
                            }
                        }
                        ...
                        collegeEstablishmentDetails.firstBatchCommencementYear = collegeInformation.firstBatchCommencementYear;
                        db.jntuh_college_establishment.Add(collegeEstablishmentDetails);
                    }
                    else
                    {
                        jntuh_college_establishment.instituteEstablishedYear = collegeInformation.instituteEstablishedYear;
                        if (collegeInformation.firstApprovalDateByAICTE != null)
                        {
                            jntuh_college_establishment.firstApprovalDateByAICTE = Utilities.DDMMYY2MMDDYY(collegeInformation.firstApprovalDateByAICTE);
                        }
                        else
                        {
                            jntuh_college_establishment.firstApprovalDateByAICTE = null;
                        }
                        ...
                        if (collegeInformation.FirstApprovalDateByAICTEDoc != null)
                        {
                            ...
                            if (ext.ToUpper().Equals(".PDF") || ext.ToUpper().Equals(".PDF"))
                            {
                                if (collegeInformation.FirstApprovalDateByAICTEDocPath == null)
                                {
                                    ...
                                    collegeInformation.FirstApprovalDateByAICTEDoc.SaveAs(string.Format("{0}/{1}{2}", Server.MapPath(approvalDateByAICTEfile), fileName, ext));
                                    collegeInformation.FirstApprovalDateByAICTEDocPath = string.Format("{0}{1}", fileName, ext);
                                    jntuh_college_establishment.firstApprovalDateByAICTEdoc = collegeInformation.FirstApprovalDateByAICTEDocPath;
                                }
                                else
                                {
                                    collegeInformation.FirstApprovalDateByAICTEDoc.SaveAs(string.Format("{0}/{1}", Server.MapPath(approvalDateByAICTEfile), collegeInformation.FirstApprovalDateByAICTEDocPath));
                        ...
                        if (collegeInformation.firstAffiliationDateByJNTU != null)
                        {
                            jntuh_college_establishment.firstAffiliationDateByJNTU = Utilities.DDMMYY2MMDDYY(collegeInformation.firstAffiliationDateByJNTU);
                        }
                        else
                        {
                            collegeInformation.firstAffiliationDateByJNTU = null;
                        ...
                        if (collegeInformation.FirstAffiliationDateByJNTUDoc != null)
                        {
                            ...
                            if (ext.ToUpper().Equals(".PDF") || ext.ToUpper().Equals(".PDF"))
                            {
                                if (collegeInformation.FirstAffiliationDateByJNTUDocPath == null)
                                {
                                    ...
                                    collegeInformation.FirstAffiliationDateByJNTUDoc.SaveAs(string.Format("{0}/{1}{2}", Server.MapPath(affiliationDateByJNTU), fileName, ext));
                                    collegeInformation.FirstAffiliationDateByJNTUDocPath = string.Format("{0}{1}", fileName, ext);
                                    jntuh_college_establishment.firstAffiliationDateByJNTUdoc = collegeInformation.FirstAffiliationDateByJNTUDocPath;
                                }
                                else
                                {
                                    collegeInformation.FirstAffiliationDateByJNTUDoc.SaveAs(string.Format("{0}/{1}", Server.MapPath(affiliationDateByJNTU), collegeInformation.FirstAffiliationDateByJNTUDocPath));
                        ...
                        jntuh_college_establishment.firstBatchCommencementYear = collegeInformation.firstBatchCommencementYear;
                        db.Entry(jntuh_college_establishment).State = EntityState.Modified;
                    }
                    db.SaveChanges();
                }
            }
        ...
        public ActionResult Edit(string collegeId)
        {
            ...
            if (userCollegeID == 0 && Roles.IsUserInRole("College"))
            {
                return RedirectToAction("Create", "PA_CollegeInformation");
            }
            if (userCollegeID == 375)
            {
                userCollegeID = Convert.ToInt32(ConfigurationManager.AppSettings["appCollegeId"]);
            ...
            else
            {
                ...
                bool isPageEditable = db.jntuh_pa_college_screens_assigned.Where(a => a.jntuh_college_screens.ScreenCode.Equals("PCI") && a.CollegeId == userCollegeID).Select(a => a.IsEditable).FirstOrDefault();
            ...
            if (jntuh_college != null)
            {
                ...
                collegeInformation.formerCollegeName = jntuh_college.formercollegename;
            ...
            if (jntuh_college_establishment != null)
            {
                collegeInformation.instituteEstablishedYear = jntuh_college_establishment.instituteEstablishedYear;
                if (jntuh_college_establishment.firstApprovalDateByAICTE != null)
                {
                    collegeInformation.firstApprovalDateByAICTE = Utilities.MMDDYY2DDMMYY(jntuh_college_establishment.firstApprovalDateByAICTE.ToString());
                }
                else
                {
                    collegeInformation.firstApprovalDateByAICTE = string.Empty;
                }
                collegeInformation.FirstApprovalDateByAICTEDocPath = jntuh_college_establishment.firstApprovalDateByAICTEdoc;

                if (jntuh_college_establishment.firstAffiliationDateByJNTU != null)
                {
                    collegeInformation.firstAffiliationDateByJNTU = Utilities.MMDDYY2DDMMYY(jntuh_college_establishment.firstAffiliationDateByJNTU.ToString());
                }
                else
                {
                    collegeInformation.firstAffiliationDateByJNTU = string.Empty;
                }
                collegeInformation.FirstAffiliationDateByJNTUDocPath = jntuh_college_establishment.firstAffiliationDateByJNTUdoc;
                collegeInformation.firstBatchCommencementYear = jntuh_college_establishment.firstBatchCommencementYear;
            }
