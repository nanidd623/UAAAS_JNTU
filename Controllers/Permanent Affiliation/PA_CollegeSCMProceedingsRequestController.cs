...
{
    [ErrorHandling]
    public class PA_CollegeSCMProceedingsRequestController : BaseController
    {
        //
        ...
        //    int lid =
        //        db.jntuh_college_screens.Where(p => p.ScreenName == "Permanent Faculty SCM Request" && p.IsActive == true).Select(s => s.Id).FirstOrDefault();
        //    jntuh_pa_college_edit_status scmphase = db.jntuh_pa_college_edit_status.Where(editStatus => editStatus.academicyearId == ay0 && editStatus.collegeId == userCollegeId && editStatus.IsCollegeEditable &&
        //                          editStatus.editFromDate <= todayDate && editStatus.editToDate >= todayDate).FirstOrDefault();
        //    if (scmphase == null && Roles.IsUserInRole("College"))
        //    {
        //        return RedirectToAction("College", "Dashboard");
        //    }
        ...
        //    DateTime SCMStartDate = Convert.ToDateTime(scmphase.editFromDate);
        ...
        //            collegescmrequests.isscmatUniversity = scmrequest.isscmatUniversity;
        ...
        //                return RedirectToAction("CollegeScmProceedingsRequest", "PA_CollegeSCMProceedingsRequest");
        //            }
        ...
        //            return RedirectToAction("ViewFaculty", "PA_CollegeSCMProceedingsRequest", new { scmid = scmId });
        //        }
        //    }
        //    return RedirectToAction("CollegeScmProceedingsRequest");
        //}
        ...
        private bool isPrincipalSCMupload()
        {
            ...
            {
                bool isPageEditable = db.jntuh_pa_college_screens_assigned.Where(a => a.jntuh_college_screens.ScreenCode.Equals("PPSU") && a.CollegeId == userCollegeId).Select(a => a.IsEditable).FirstOrDefault();
        ...
        private bool isFacultySCMupload()
        {
            ...
            if (status > 0 && Roles.IsUserInRole("College"))
            {
                bool isPageEditable = db.jntuh_pa_college_screens_assigned.Where(a => a.jntuh_college_screens.ScreenCode.Equals("PFSU") && a.CollegeId == userCollegeId).Select(a => a.IsEditable).FirstOrDefault();
        ...
        //        return RedirectToAction("ScmFacultyVerfication", "PA_CollegeSCMProceedingsRequest", new { collegeId = collegeId });
        //    }
        //    return RedirectToAction("ScmFacultyVerfication", "PA_CollegeSCMProceedingsRequest");
        //}
        ...
        //                TempData["Success"] = "Faculty Add Successfully";
        //            }
        //            return RedirectToAction("ScmFacultyVerfication", "PA_CollegeSCMProceedingsRequest", new { collegeId = facultynotapproved.CollegeId });
        //        }
        //    }
        //    return RedirectToAction("ScmFacultyVerfication", "PA_CollegeSCMProceedingsRequest");
        //}
        ...
        //           it =>
        //               it.CollegeId == payclgcode && it.AcademicYearId == ay0 && it.AuthStatus == "0300" &&
        //               it.TxnDate.Year == todayDate.Year && it.PaymentTypeID == paymentid)
        //           .Select(s => s).ToList();
        //    ViewBag.Payments = paymenthistory;

        //    ViewBag.VisiableRequestSumissionButton = db.jntuh_scmproceedingsrequests.Where(e => e.CollegeId == userCollegeId && e.SpecializationId == 0 && e.DEpartmentId == 0 && e.DegreeId == 0 && e.RequestSubmittedDate == null && e.CreatedOn >= SCMStartDate).Select(e => e).Count();
        ...
        //    {
        //        TempData["Error"] = "This Registration Number doesn't Exist.";
        //        return RedirectToAction("CollegeScmProceedingsPrincipalRequest", "PA_CollegeSCMProceedingsRequest");
        //    }
        //    if (jntuh_registered_faculty.Blacklistfaculy == true || jntuh_registered_faculty.AbsentforVerification == true)
        //    {
        //        TempData["Error"] = "Faculty Registration Number is in Blacklist.";
        ...
        //                return RedirectToAction("CollegeSCMRequestFaculty", "PA_CollegeSCMProceedingsRequest");
        //            }
        //        }
        //        else
        //        {
        ...
        //        while (facultycount > 0)
        //        {
        //            RequestsubmittedAmount = RequestsubmittedAmount + 11000;
        //            facultycount = facultycount - 10;
        ...
        //        {
        //            RequestnotsubmittedAmount = RequestnotsubmittedAmount + 11000;
        //            notsubfacultycount = notsubfacultycount - 10;
        ...
        //    var payments = db.jntuh_paymentresponse.Where(it => it.CollegeId == clgCode && it.AcademicYearId == ay0 && it.AuthStatus == "0300" && it.TxnDate.Year == currentYear && it.PaymentTypeID == 9)
        //            .Select(s => s.TxnAmount).ToList().Count() > 0 ?
        //        db.jntuh_paymentresponse.Where(it => it.CollegeId == clgCode && it.AcademicYearId == ay0 && it.AuthStatus == "0300" && it.TxnDate.Year == currentYear && it.PaymentTypeID == 9)
        //        .Select(s => s.TxnAmount).Sum() : 0;
        //    var paymenthistory =
        //        db.jntuh_paymentresponse.Where(
        //            it =>
        //                it.CollegeId == clgCode && it.AcademicYearId == ay0 && it.AuthStatus == "0300" &&
        //                it.TxnDate.Year == currentYear && it.PaymentTypeID == 9)
        //            .Select(s => s).ToList();
        //    ViewBag.Payments = paymenthistory;
        ...
        //                r.CustomerID == dbResponse.CustomerID && r.BankReferenceNo == dbResponse.BankReferenceNo)
        //            .FirstOrDefault();
        ...
        //    {
        //        reqsubamount = reqsubamount + 11000;
        //        reqsubfacultycount = reqsubfacultycount - 4;
        //        paymentdetails.amount = scmamount;
        //    }
        ...
        //    {
        //        reqnotsubamount = reqnotsubamount + 11000;
        //        reqnotsubfacultycount = reqnotsubfacultycount - 4;
        ...
        //          .Select(s => s.id)
        //          .FirstOrDefault();
        //    var payments = db.jntuh_paymentresponse.Where(it => it.CollegeId == clgCode && it.AcademicYearId == ay0 && it.AuthStatus == "0300" && it.TxnDate.Year == currentYear && it.PaymentTypeID == paymentid)
        //            .Select(s => s.TxnAmount).ToList().Count() > 0 ?
        //        db.jntuh_paymentresponse.Where(it => it.CollegeId == clgCode && it.AcademicYearId == ay0 && it.AuthStatus == "0300" && it.TxnDate.Year == currentYear && it.PaymentTypeID == paymentid)
        //        .Select(s => s.TxnAmount).Sum() : 0;
        //    var paymenthistory =
        //        db.jntuh_paymentresponse.Where(
        //            it =>
        //                it.CollegeId == clgCode && it.AcademicYearId == ay0 && it.AuthStatus == "0300" &&
        //                it.TxnDate.Year == currentYear && it.PaymentTypeID == paymentid)
        //            .Select(s => s).ToList();
        //    ViewBag.Payments = paymenthistory;
        //    ViewBag.totalFee = totalamount;
        //    decimal remaingamount = totalamount - payments;
        ...
        //                db.SaveChanges();
        //                TempData["Success"] = "Faculty Add Successfully";
        //                return RedirectToAction("AppealCollegeScmProceedingsRequest", "PA_CollegeSCMProceedingsRequest");
        //            }
        //        }
        //        //}
        //        // else
        ...
        //            db.SaveChanges();
        //            TempData["Success"] = "Faculty Deleted Successfully";
        //            return RedirectToAction("AppealViewFaculty", "PA_CollegeSCMProceedingsRequest", new { scmid = scmId });
        //        }
        //    }
        //    return RedirectToAction("AppealCollegeScmProceedingsRequest");
        //}
        ...
        //    return RedirectToAction("AppealCollegeScmProceedingsPrincipalRequest", "PA_CollegeSCMProceedingsRequest");
        //}
    ...
    //    [Remote("CheckRegistrationNumber", "PA_CollegeSCMProceedingsRequest", HttpMethod = "POST", ErrorMessage = "Registration Number doesn't Exist")]
