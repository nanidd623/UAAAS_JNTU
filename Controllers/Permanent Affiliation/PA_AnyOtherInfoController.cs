...
{
    [ErrorHandling]
    public class PA_AnyOtherInfoController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            var extraactivities = db.jntuh_extracurricularactivities.Where(i => i.isactive && i.activitytype == 19).ToList();
            ...
            if (status == 0 && Roles.IsUserInRole("College"))
            {
                ...
                return RedirectToAction("View", "PA_AnyOtherInfo");
            }
            else
            {
                ViewBag.IsEditable = true;

                bool isPageEditable = db.jntuh_pa_college_screens_assigned.Where(a => a.jntuh_college_screens.ScreenCode.Equals("PAI") && a.CollegeId == userCollegeId).Select(a => a.IsEditable).FirstOrDefault();
        ...
        public ActionResult Create(List<CollegeExtraCirActivities> extracurricularInformation)
        {
            ...
            foreach (var item in extracurricularInformation)
            {
                ...
                {
                    const string affiliationfile = "~/Content/Upload/College/AnyOtherInfo";
        ...
        public ActionResult View()
        {
            ...
            var masteractivities = db.jntuh_extracurricularactivities.Where(i => i.isactive && i.activitytype == 19).ToList();
