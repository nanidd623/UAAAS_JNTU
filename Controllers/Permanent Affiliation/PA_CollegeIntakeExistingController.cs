...
{
    [ErrorHandling]
    public class PA_CollegeIntakeExistingController : BaseController
    {
        ...
        public ActionResult Index(string collegeId)
        {
            ...
            if (status == 0 && Roles.IsUserInRole("College"))
            {
                return RedirectToAction("View", "PA_CollegeIntakeExisting");
            }
            bool isPageEditable =
                db.jntuh_pa_college_screens_assigned.Where(
                    a => a.jntuh_college_screens.ScreenCode.Equals("PCIE") && a.CollegeId == userCollegeID)
        ...
        public ActionResult FeeDetailsandPayment()
        {
            ...
            else
            {
                ...
                if (userCollegeID > 0 && userCollegeID != null)
                {
                    ...
                    var editstatus = GetPageEditableStatus(userCollegeID);
                    ...
                    else
                    {
                        ...
                        bool isPageEditable = db.jntuh_pa_college_screens_assigned.Where(a => a.jntuh_college_screens.ScreenCode.Equals("PFD") && a.CollegeId == userCollegeID).Select(a => a.IsEditable).FirstOrDefault();
