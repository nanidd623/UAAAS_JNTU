...
{
    [ErrorHandling]
    public class PA_SocietyInformationController : BaseController
    {
        ...
        public ActionResult Create(string collegeId)
        {
            ...
            {
                return RedirectToAction("View", "PA_SocietyInformation");
            }
            if (userCollegeID > 0 && userSocietyID > 0 && userEstablishmentID > 0 && (Roles.IsUserInRole("DataEntry") || Roles.IsUserInRole("Admin")))
            {
                return RedirectToAction("Edit", "PA_SocietyInformation", new { collegeId = Utilities.EncryptString(userCollegeID.ToString(), WebConfigurationManager.AppSettings["CryptoKey"]).ToString() });
            }
            ...
            bool isPageEditable = db.jntuh_pa_college_screens_assigned.Where(a => a.jntuh_college_screens.ScreenCode.Equals("PSI") && a.CollegeId == userCollegeID).Select(a => a.IsEditable).FirstOrDefault();
        ...
        private void SaveSocietyInformation(SocietyInformation societyInformation)
        {
            ...
            if (membershipUser != null)
            {
                ...
                if (!ModelState.IsValid)
                {
                    ...
                    if (societyInformation.RegistrationDocument != null && societyInformation.MembersDetailsDocument != null)
                    {
                        ...
                        {
                            if (String.IsNullOrEmpty(societyInformation.RegistrationDocumentfile))
                            {
                            ...
                            {
                                societyInformation.RegistrationDocument.SaveAs(string.Format("{0}/{1}",
                                    Server.MapPath(societydocuments), societyInformation.RegistrationDocumentfile));
                            }
                        }
                        if (societyInformation.MembersDetailsDocument != null)
                        {
                            ...
                            if (ext != null && ext.ToUpper().Equals(".PDF"))
                            {
                                if (String.IsNullOrEmpty(societyInformation.MembersDetailsDocumentfile))
                                {
                                    if (jntuhCollege != null)
                                    {
                                ...
                                {
                                    societyInformation.MembersDetailsDocument.SaveAs(string.Format("{0}/{1}",
                                        Server.MapPath(societydocuments), societyInformation.MembersDetailsDocumentfile));
                                }
                            }
                        }
                    }
                    else if (!String.IsNullOrEmpty(societyInformation.RegistrationDocumentfile) && !String.IsNullOrEmpty(societyInformation.MembersDetailsDocumentfile))
                    {
                    ...
                    if (societyInformation.Societymoudoc != null)
                    {
                        ...
                        if (societyInformation.Societymoudoc != null)
                        {
                            if (String.IsNullOrEmpty(societyInformation.Societymoufile))
                            {
                            ...
                            {
                                societyInformation.Societymoudoc.SaveAs(string.Format("{0}/{1}",
                                    Server.MapPath(societymoudocuments), societyInformation.Societymoufile));
                            }
                        }
                    }
                    else
                    ...
                    if (societyInformation.Societybyelawsdoc != null)
                    {
                        ...
                        if (societyInformation.Societybyelawsdoc != null)
                        {
                            if (String.IsNullOrEmpty(societyInformation.Societybylawsfile))
                            {
                            ...
                            {
                                societyInformation.Societybyelawsdoc.SaveAs(string.Format("{0}/{1}",
                                    Server.MapPath(societybylawdocuments), societyInformation.Societybylawsfile));
                            }
                        }
                    }
                    else
        ...
        public ActionResult Edit(string collegeId)
        {
            ...
            {
                return RedirectToAction("Create", "PA_SocietyInformation");
            }

            if (userSocietyID == 0 && userEstablishmentID == 0 && (Roles.IsUserInRole("Admin") || Roles.IsUserInRole("DataEntry")))
            {
                return RedirectToAction("Create", "PA_SocietyInformation", new { collegeId = Utilities.EncryptString(userCollegeID.ToString(), WebConfigurationManager.AppSettings["CryptoKey"]).ToString() });
            }
            DateTime todayDate = DateTime.Now.Date;
            int actualYear = db.jntuh_academic_year.Where(a => a.isActive == true && a.isPresentAcademicYear == true).Select(a => a.actualYear).FirstOrDefault();
            int prAy =
