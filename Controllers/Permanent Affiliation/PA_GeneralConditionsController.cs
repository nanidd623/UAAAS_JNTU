...
{
    [ErrorHandling]
    public class PA_GeneralConditionsController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            var extraactivities = db.jntuh_extracurricularactivities.Where(i => i.isactive && i.activitytype == 15).ToList();
            ...
            if (status == 0 && Roles.IsUserInRole("College"))
            {
                ...
                return RedirectToAction("View", "PA_GeneralConditions");
            }
            else
            {
                ViewBag.IsEditable = true;
                bool isPageEditable = db.jntuh_pa_college_screens_assigned.Where(a => a.jntuh_college_screens.ScreenCode.Equals("PGC") && a.CollegeId == userCollegeId).Select(a => a.IsEditable).FirstOrDefault();
        ...
        public ActionResult Create(List<CollegeExtraCirActivities> extracurricularInformation)
        {
            ...
            foreach (var item in extracurricularInformation)
            {
                ...
                {
                    const string affiliationfile = "~/Content/Upload/College/GeneralConditions";
        ...
        public ActionResult View()
        {
            ...
            var masteractivities = db.jntuh_extracurricularactivities.Where(i => i.isactive && i.activitytype == 15).ToList();
