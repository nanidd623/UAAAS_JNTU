...
{
    [ErrorHandling]
    public class _40PercentAffiliationProceedingsReportWith10percentReportController : BaseController
    {
        ...
        private string SaveCollegeDefficiencyLetterPdf(string collegeCode, string type)
        {
            ...
            fullPath = path + collegeCode + "-" + ECollegeid + "-40PercentAffiliationProceedingsWith10%.pdf";
            ...
            sr = System.IO.File.OpenText(type == "NoAdmisssion" ? Server.MapPath("~/Content/NoAdmissionStatusAffiliation.html") : Server.MapPath("~/Content/AffiliationProceedings.html"));
            ...
            else if (type == "AllClear")
            {
                ...
                //contents = contents.Replace("##Def_Table##", courses[3]);
            ...
            else if (type == "NoAdmisssion")
            {
                string noadmissioncourses = NoAdmissionLists(collegeid);
                contents = contents.Replace("##Def_Table##", noadmissioncourses);
            }
        ...
        {
            string courses = string.Empty;
            string defcourses = string.Empty;
            ...
            defcourses += "<table border='1' cellpadding='3' cellspacing='0' width='100%' style='font-family: Times New Roman; font-size: 9px; font-weight: normal; background-color: #fff; margin: 0 auto;'>";
            defcourses += "<tr>";
            defcourses += "<th colspan='1' align='center'><b>S.No</b></th>";
            defcourses += "<th colspan='10'><b>Name of the Course</b></th>";
            //defcourses += "<th colspan='2' align='center'><b>Intake</b></th>";
            defcourses += "</tr>";
            ...
            foreach (var course in deficiencyCourses)
            {
                ...
                defcourses += "<tr>";
                defcourses += "<td colspan='1' align='center'>" + (rowCount + 1) + ".</td>";
                course.Shift = "1";
                ...
                if (course.Shift == "1")
                {
                    defcourses += "<td colspan='10'>" + course.Degree + " - " + course.Specialization + "</td>";
                }

                //defcourses += "<td colspan='2' align='center'>" + course.TotalIntake + "</td>";
                defcourses += "</tr>";
                    ...
                    if (course.TotalIntake != 0)
                    {
                        ...
                        if (secondshift != null)
                        {
                            ...
                            if (approvedIntake != 0)
                            {
                                ...
                                //if (course.Shift == "2")
                                //{
                                //    defcourses += "<td colspan='10'>" + course.Degree + " - " + course.Specialization + " - 2</td>";
                                //}

                                //defcourses += "<td colspan='2' align='center'>" + GetIntake(collegeId, AY1, course.SpecializationId, 2, 1) + "</td>";
                                //defcourses += "</tr>";
            ...
            if (affiliatedCount == 0)
            {
                ...
                //defcourses += "<tr>";
                //defcourses += "<td colspan='13' align='center'>NIL</td>";
                //defcourses += "</tr>";
            }
            ...
            return courses + "$" + assessments + "$" + defiencyRows + "$" + defcourses;
        }
...
//New
        ...
        #region For NoAdmissionLists

        public string NoAdmissionLists(int? collegeId)
        {

            var collegeIntakeExisting = new List<CollegeIntakeExisting>();
            var defcourses = string.Empty;
            var rowCount = 0;
            defcourses += "<table border='1' cellpadding='3' cellspacing='0' width='100%' style='font-family: Times New Roman; font-size: 9px; font-weight: normal; background-color: #fff; margin: 0 auto;'>";
            defcourses += "<tr>";
            defcourses += "<th colspan='1' align='center'><b>S.No</b></th>";
            ...
            if (collegeId != null)
            {
                ...
                var intake = db.jntuh_college_intake_existing.Where(i => i.collegeId == collegeId).ToList();
                ...
                collegeIntakeExisting =
                    collegeIntakeExisting.AsEnumerable()
                        ...
                        .Select(r => r.First())
                        .ToList();
                foreach (var course in collegeIntakeExisting.Where(i => i.shiftId == 1).ToList())
                {
                    defcourses += "<tr>";
                    defcourses += "<td colspan='1' align='center'>" + (rowCount + 1) + ".</td>";
                    course.Shift = "1";
                    ...
                    var secondshift = intake.Where(e => e.collegeId == collegeId && e.specializationId == course.specializationId && e.shiftId == 2).Select(e => e).FirstOrDefault();
                    ...
                    if (secondshift != null)
                    {
                        ...
                        var AY1 = db.jntuh_academic_year.Where(a => a.actualYear == (presentYear + 1)).Select(a => a.id).FirstOrDefault();

                        var approvedIntake = GetIntake((int)collegeId, AY1, course.specializationId, 2, 1);
                        ...
                        if (approvedIntake != 0)
                        {
                            ...
                            //defcourses += "<td colspan='2' align='center'>" + GetIntake((int)collegeId, AY1, course.specializationId, 2, 1) + "</td>";
                            defcourses += "</tr>";
