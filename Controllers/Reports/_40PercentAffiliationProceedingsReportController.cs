...
{
    [ErrorHandling]
    public class _40PercentAffiliationProceedingsReportController : BaseController
    {
        ...
        private string SaveCollegeDefficiencyLetterPdf(string collegeCode, string type)
        {
            ...
            fullPath = path + collegeCode + "-" + ECollegeid + "-40PercentAffiliationProceedings.pdf";
        ...
        public List<CollegeFacultyWithIntakeReport> collegeFaculty(int? collegeId)
        {
            ...
            if (collegeId != null)
            {
                ...
                //  Count Principal and Faculty also.(Requested colleges only)

                int[] CollegeIDS = new int[] { 113, 172, 360 };
