...
{
    public class AffiliationPharmacyUndertakingController : BaseController
    {
        ...
        private string SaveCollegeDefficiencyLetterPdf(string collegeCode, string type)
        {
            ...
            sr = System.IO.File.OpenText(Server.MapPath("~/Content/AffiliationUndertakingpharmacy.html"));
        ...
        public List<CollegeFacultyLabs> PharmacyDeficienciesInFaculty(int? collegeID)
        {
            ...
            foreach (var item in facultyCounts)
            {
                ...
                if (item.Degree == "Pharm.D")//&& @ViewBag.BpharmcyCondition == "No"
                {
                    ...
                    if (deptloop == 1)
                    {
                        if (tFaculty >= rFaculty && ((tFaculty - rFaculty) >= pharmadreqfaculty) && item.BPharmacySubGroup1Count >= item.BPharmacySubGroupRequired)
                        {
                            minimumRequirementMet = "NO";
                        ...
                        {
                            minimumRequirementMet = "YES";
                            remainingphramdFaculty = remainingmpharmacyfaculty = tFaculty - rFaculty;
                        }
                    }
                }
        ...
        public List<CollegeFacultyWithIntakeReport> PharmacyCollegeFaculty(int? collegeId)
        {
            ...
            if (collegeId != null)
            {
                ...
                if (BpharcyrequiredFaculty > 0)
                {
                    ...
                    {
                        if (group1Subcount >= (bpharmacyintake >= 100 ? 6 : 4) && group2Subcount >= (bpharmacyintake >= 100 ? 6 : 5) && group3Subcount >= (bpharmacyintake >= 100 ? 5 : 4) && group4Subcount >= 1)//&& group5Subcount >= 2 && group6Subcount >= (bpharmacyintake == 100 ? 3 : 2)
                        {
