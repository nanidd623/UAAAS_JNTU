...
{
    [ErrorHandling]
    public class A418FormatController : Controller
    {
        //
        // GET: /A418Format/
        ...
        public ActionResult CollegeData(int preview, int collegeId)
        {
            try
            {
                ...
                return File(path, "application/pdf", "A-420-" + collegeCode + ".pdf");
            }
            catch (Exception ex)
            {
        ...
        private string SaveCollegeDataPdf(int preview, int collegeId)
        {
            ...
            try
            {
                ...
                if (preview == 0)
                {
                    ...
                    fullPath = path + "/CollegeData/A-420_" + collegeCode + "_" + DateTime.Now.ToString("yyyMMddHHmmss") +
                               ".pdf";
                ...
                sr = System.IO.File.OpenText(Server.MapPath("~/Content/A-418.html"));
        ...
        //    string path = "~/Content/Upload/Faculty/PHOTOS";
        ...
        //        }
        //        var exc = Path.GetExtension(image.FileName);
        //        if (exc.ToUpper().Equals(".JPG") || exc.ToUpper().Equals(".JPEG"))
        //        {


        //            string fileName = DateTime.Now.ToString("yyyy-MM-dd") + "_" + image.FileName.Substring(0, 3);
        //              image.SaveAs(string.Format("{0}/{1}{2}", Server.MapPath(path), fileName, exc));
        //           // image.SaveAs(string.Format("{0}/{1}{2}",Server.MapPath(path),filename,exc));
        //        }
        //    }
        //    else
