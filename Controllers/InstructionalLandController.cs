...
{
    [ErrorHandling]
    public class InstructionalLandController : BaseController
    {
        ...
        public ActionResult Create(string collegeId)
        {
            ...
            {
                return RedirectToAction("Edit", "InstructionalLand", new { collegeId = Utilities.EncryptString(userCollegeID.ToString(), WebConfigurationManager.AppSettings["CryptoKey"]).ToString() });
            }
            ...
            bool isPageEditable = db.jntuh_college_screens_assigned.Where(a => a.jntuh_college_screens.ScreenCode.Equals("IA") && a.CollegeId == userCollegeID).Select(a => a.IsEditable).FirstOrDefault();
        ...
        public ActionResult Edit(string collegeId)
        {
            ...
            if (collegeAreaId == 0)
            {
                return RedirectToAction("Create", "InstructionalLand");
            }
            ...
            else
            {
                bool isPageEditable =
                    db.jntuh_college_screens_assigned.Where(
                        a => a.jntuh_college_screens.ScreenCode.Equals("IA") && a.CollegeId == userCollegeID)
            ...
            List<string> collegeDegrees = (from ie in db.jntuh_college_intake_existing
                                           ...
                                           where ie.academicYearId == (prAy) && (ie.proposedIntake != 0) && ie.collegeId == userCollegeID
