...
{
    [ErrorHandling]
    public class CollegeJHubActivitiesController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            var collgeextraactivities = db.jntuh_college_jhubactivities.Where(i => i.isactive == true && i.collegeid == userCollegeID).ToList();
            var extraactivities = db.jntuh_jhubactivities.Where(i => i.isactive == true && i.activitytype == 1).ToList();
            ...
            if (status == 0 && Roles.IsUserInRole("College"))
            {
                ...
                return RedirectToAction("View", "CollegeJHubActivities");
            }
            else
            {
                ViewBag.IsEditable = true;
                var isPageEditable = db.jntuh_college_screens_assigned.Where(a => a.jntuh_college_screens.ScreenCode.Equals("JHU") && a.CollegeId == userCollegeID).Select(a => a.IsEditable).FirstOrDefault();
                if (isPageEditable)
                {
                    ViewBag.IsEditable = true;
                }
            ...
            var lstactivities = new List<CollegeJHubActivities>();
            foreach (var item in extraactivities)
            {
                var objactivities = new CollegeJHubActivities()
                {
                    activityid = item.sno,
        ...
        [Authorize(Roles = "Admin,College,SuperAdmin")]
        [HttpPost]
        public ActionResult Create(List<CollegeJHubActivities> extracurricularInformation)
        {
            int userID = Convert.ToInt32(Membership.GetUser(User.Identity.Name).ProviderUserKey);
            int userCollegeID = db.jntuh_college_users.Where(u => u.userID == userID).Select(u => u.collegeID).FirstOrDefault();
            if (userCollegeID == 375)
            ...
            if (userCollegeID > 0)
            {
                ...
                {
                    var objextraactivities = new jntuh_college_jhubactivities()
                    {
                    ...
                    {
                        var affiliationfile = "~/Content/Upload/College/JHubActivities";
                    ...
                    db.jntuh_college_jhubactivities.Add(objextraactivities);
                    db.SaveChanges();
                }
            }
            return RedirectToAction("View");
        ...
        public ActionResult View(string id)
        {
            ...
            var extraactivities = db.jntuh_college_jhubactivities.Where(i => i.isactive == true && i.collegeid == userCollegeID).ToList();
            var jntuh_academic_year = db.jntuh_academic_year.Select(s => s).ToList();
            int actualYear = jntuh_academic_year.Where(a => a.isActive == true && a.isPresentAcademicYear == true).Select(a => a.actualYear).FirstOrDefault();
            int ay0 = jntuh_academic_year.Where(a => a.actualYear == (actualYear + 1)).Select(a => a.id).FirstOrDefault();
            var lstactivities = (from item in extraactivities
                                 ...
                                 select new CollegeJHubActivities()
                                 {
                                     activityid = item.activityid,
            ...
            {
                ViewBag.IsEditable = true;
                bool isPageEditable = db.jntuh_college_screens_assigned.Where(a => a.jntuh_college_screens.ScreenCode.Equals("JHU") && a.CollegeId == userCollegeID).Select(a => a.IsEditable).FirstOrDefault();
                if (isPageEditable)
                {
                    ViewBag.IsEditable = true;
                }
        ...
        public ActionResult Edit(string collegeId)
        {
            ...
            var collgeextraactivities = db.jntuh_college_jhubactivities.Where(i => i.isactive == true && i.collegeid == userCollegeID && extraactivitiesIds.Contains(i.activityid)).ToList();
            ViewBag.extraactivities = extraactivities;
            int status = db.jntuh_college_edit_status.Where(editStatus => editStatus.collegeId == userCollegeID && editStatus.academicyearId == ay0 &&
                                                                                     editStatus.IsCollegeEditable == true &&
                                                                                     editStatus.editFromDate <= todayDate &&
        ...
        [Authorize(Roles = "Admin,College,SuperAdmin")]
        [HttpPost]
        public ActionResult Edit(List<CollegeJHubActivities> extracurricularInformation)
        {
            int userID = Convert.ToInt32(Membership.GetUser(User.Identity.Name).ProviderUserKey);
            int userCollegeID = db.jntuh_college_users.Where(u => u.userID == userID).Select(u => u.collegeID).FirstOrDefault();
            if (userCollegeID == 375)
            ...
            int actualYear = jntuh_academic_year.Where(a => a.isActive == true && a.isPresentAcademicYear == true).Select(a => a.actualYear).FirstOrDefault();
            int ay0 = jntuh_academic_year.Where(a => a.actualYear == (actualYear + 1)).Select(a => a.id).FirstOrDefault();
            var collegeExtraActivities = db.jntuh_college_jhubactivities.Where(i => i.isactive == true && i.collegeid == userCollegeID).ToList();
            if (userCollegeID > 0)
            {
