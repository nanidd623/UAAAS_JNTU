...
{
    [ErrorHandling]
    public class OperationalFundsController : BaseController
    {
        ...
        public ActionResult Index(string collegeId)
        {
            ...
            {
                return RedirectToAction("View", "OperationalFunds");
            }
            bool isPageEditable = db.jntuh_college_screens_assigned.Where(a => a.jntuh_college_screens.ScreenCode.Equals("OF") && a.CollegeId == userCollegeID).Select(a => a.IsEditable).FirstOrDefault();
