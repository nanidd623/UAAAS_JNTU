...
namespace UAAAS.Controllers
{
    ...
    public class FacultyController : BaseController
    {
        ...
        public ActionResult Teaching(string collegeId)
        {
            ...
            bool isPageEditable = db.jntuh_college_screens_assigned.Where(a => a.jntuh_college_screens.ScreenCode.Equals("TF") && a.CollegeId == userCollegeID).Select(a => a.IsEditable).FirstOrDefault();
        ...
        public ActionResult EditFaculty(CollegeFaculty faculty)
        {
          ...
          db.jntuh_college_principal_registered.Where(
            ...
            if (jntuh_registered_faculty != null)
            {
                if (faculty.facultyPresentDesignationId == 4)
                {
                    jntuh_registered_faculty.DesignationId = faculty.facultyPresentDesignationId;
                    jntuh_registered_faculty.OtherDesignation = faculty.facultyPresentOtherDesignation;
                }
                else
                {
                    jntuh_registered_faculty.DesignationId = faculty.facultyPresentDesignationId;
                    jntuh_registered_faculty.OtherDesignation = null;
                }
            ...
            string facultyForm16_26AS = "~/Content/Upload/College/Faculty/Form16_26AS";
            if (updatefacultyexperiance != null)
            {
                if (faculty.AppointmentOrderDocument != null)
                {
                    ...
                    {
                        string fileName = DateTime.Now.ToString("yyyyMMdd-HHmmssffffff") + "-" +
                        isRegisteredFaculty.RegistrationNumber.Substring(0, 1) + "-" + isRegisteredFaculty.LastName.Trim().Substring(0, 1);
                ...
                //Optional
                if (faculty.facultyForm16 != null)
                {
                    if (!Directory.Exists(Server.MapPath(facultyForm16_26AS)))
                    {
                        Directory.CreateDirectory(Server.MapPath(facultyForm16_26AS));
                    }

                    var ext = Path.GetExtension(faculty.facultyForm16.FileName);

                    if (ext.ToUpper().Equals(".PDF"))
                    {
                        string fileName = DateTime.Now.ToString("yyyyMMdd-HHmmssffffff") + "-" +
                        isRegisteredFaculty.RegistrationNumber.Substring(0, 1) + "-" + isRegisteredFaculty.LastName.Trim().Substring(0, 1);
                        faculty.facultyForm16.SaveAs(string.Format("{0}/{1}{2}", Server.MapPath(facultyForm16_26AS),
                            fileName, ext));
                        faculty.ViewfacultyForm16 = string.Format("{0}{1}", fileName, ext);
                        updatefacultyexperiance.FacultyForm16 = faculty.ViewfacultyForm16;
                    }
                }
                ...
                updatefacultyexperiance.FacultyGrossSalary = faculty.facultyGrossSalary;
            ...
            else
            {
                ...
                if (faculty.RelivingDocument != null)
                {
                    ...
                    {
                        string fileName = DateTime.Now.ToString("yyyyMMdd-HHmmssffffff") + "-" +
                        isRegisteredFaculty.RegistrationNumber.Substring(0, 1) + "-" + isRegisteredFaculty.LastName.Substring(0, 1);
                        faculty.RelivingDocument.SaveAs(string.Format("{0}/{1}{2}", Server.MapPath(facultyrelevingletters),
                            fileName, ext));
                        faculty.ViewRelivingDocument = string.Format("{0}{1}", fileName, ext);
            ...
            if (updatefacultyexperiance != null && updatefacultyexperiance.Id > 0)
            {
                ...
                objART.grosssalary = updatefacultyexperiance.FacultyGrossSalary;
            ...
            else
            {
                ...
                objART.grosssalary = facultyexperiance.FacultyGrossSalary;
        ...
        public ActionResult FacultyRegistrationNumber(string collegeId, string fid)
        {
            ...
            if (facultyId != 0)
            {
                ...
                faculty.facultyPresentDesignationId = regfaculty.DesignationId;
                faculty.presentdesignation = db.jntuh_designation.Where(d => d.id == faculty.facultyDesignationId).Select(d => d.designation).FirstOrDefault();
                faculty.facultyPresentOtherDesignation = regfaculty.OtherDesignation;
            ...
            if (facultyexperiance != null)
            {
                ...
                faculty.facultyGrossSalary = facultyexperiance.FacultyGrossSalary;
                ...
                faculty.ViewfacultyForm16 = facultyexperiance.FacultyForm16;
            }
        ...
        public ActionResult AdocFacultyRegistrationNumber(CollegeFaculty faculty)
        {
            ...
            {
                TempData["Error"] = "Invalid Faculty Registration Number.";
                return RedirectToAction("ViewTeaching", "Faculty");
            }
          ...
          db.jntuh_college_principal_registered.Where(
            ...
            if (TempData["Error"] == null)
            {
                ...
                if (faculty.facultyAadharPhotoDocument != null)
                {
                    ...
                    {
                        string fileName = DateTime.Now.ToString("yyyyMMdd-HHmmssffffff") + "-" +
                        jntuh_registered_facultyget.RegistrationNumber.Substring(0, 1) + "-" + jntuh_registered_facultyget.LastName.Trim().Substring(0, 1);
                ...
                if (faculty.facultyForm16 != null)
                {
                    ...
                    if (ext.ToUpper().Equals(".PDF"))
                    {
                        ...
                        faculty.facultyForm16.SaveAs(string.Format("{0}/{1}{2}", Server.MapPath(facultyForm16_26AS),
                            fileName, ext));
                        faculty.ViewfacultyForm16 = string.Format("{0}{1}", fileName, ext);
                        facultyexperiance.FacultyForm16 = faculty.ViewfacultyForm16;
                    }
                }
                if (faculty.Previouscollegeid == 0)
                {
                ...
                facultyexperiance.FacultyGrossSalary = faculty.facultyGrossSalary.Trim();
                if (!String.IsNullOrEmpty(faculty.dateOfAppointment))
                    facultyexperiance.facultyDateOfAppointment = Models.Utilities.DDMMYY2MMDDYY(faculty.dateOfAppointment);
                if (!String.IsNullOrEmpty(faculty.dateOfResignation))
                    facultyexperiance.facultyDateOfResignation =
        ...
        public JsonResult ViewTeachingJson(string id, string strType)
        {
            ...
            foreach (var data in TeachingFacultyData)
            {
                ...
                var facultyTracking = db.jntuh_college_facultytracking.Where(ft =>
                    //ft.academicYearId == ay0 &&
                    //ft.isActive == true &&
                    ft.RegistrationNumber == data.RegistrationNumber
                    ).ToList();

                if (facultyTracking.Count > 0)
                {
                    newcollegeFaculty.IsFacultyTracking = true;
                    newcollegeFaculty.RegNum = UAAAS.Models.Utilities.EncryptString(data.RegistrationNumber, WebConfigurationManager.AppSettings["CryptoKey"]);
                    newcollegeFaculty.FacName = UAAAS.Models.Utilities.EncryptString(newcollegeFaculty.facultyFirstName, WebConfigurationManager.AppSettings["CryptoKey"]);
                }
                else
                {
                    newcollegeFaculty.IsFacultyTracking = false;
                }
        ...
        [Authorize(Roles = "Admin,College")]
        public ActionResult ViewFacultyTracking(string regNum, string facName)
        {
            var jntuh_academic_year = db.jntuh_academic_year.Select(s => s).ToList();
            int actualYear = jntuh_academic_year.Where(a => a.isActive == true && a.isPresentAcademicYear == true).Select(a => a.actualYear).FirstOrDefault();
            int ay0 = jntuh_academic_year.Where(a => a.actualYear == (actualYear + 1)).Select(a => a.id).FirstOrDefault();

            string dec_regNum = UAAAS.Models.Utilities.DecryptString(regNum, WebConfigurationManager.AppSettings["CryptoKey"]);
            string dec_facName = UAAAS.Models.Utilities.DecryptString(facName, WebConfigurationManager.AppSettings["CryptoKey"]);

            ViewBag.FacultyName = dec_facName;
            ViewBag.RegistrationNumber = dec_regNum;

            var facultyTracking = db.jntuh_college_facultytracking.Where(ft =>
                //ft.academicYearId == ay0 &&
                //ft.isActive == true &&
                ft.RegistrationNumber == dec_regNum).OrderByDescending(ft => ft.Createdon).ToList();

            List<CollegeFacultyTracking> CollegeFacultyTrackingList = new List<CollegeFacultyTracking>();

            foreach (var item in facultyTracking)
            {
                CollegeFacultyTracking obj = new CollegeFacultyTracking();
                obj.Department = db.jntuh_department.Where(d => d.id == item.DepartmentId).Select(d => d.departmentName).FirstOrDefault();
                obj.Specialization = db.jntuh_specialization.Where(s => s.id == item.SpecializationId).Select(s => s.specializationName).FirstOrDefault();
                obj.AadhaarNumber = item.aadhaarnumber;
                obj.AadhaarDoc = item.aadhaardocument;
                obj.FacultyJoinDate = UAAAS.Models.Utilities.MMDDYY2DDMMYY(item.FacultyJoinDate.ToString()).ToString();
                obj.FacultyJoinDoc = item.FacultyJoinDocument;
                obj.ReleavingDate = UAAAS.Models.Utilities.MMDDYY2DDMMYY(item.relevingdate.ToString()).ToString();
                obj.ReleavingDoc = item.relevingdocumnt;
                obj.ScmDoc = item.scmdocument;
                obj.Payscale = item.payscale;
                obj.Designation = item.designation;
                obj.FacultyType = item.FacultyType;
                //obj.CreatedOn = UAAAS.Models.Utilities.DDMMYY2MMDDYY(item.Createdon.ToString());
                obj.CreatedOn = item.Createdon;

                CollegeFacultyTrackingList.Add(obj);
            }

            return View(CollegeFacultyTrackingList);
        }
        ...
        public ActionResult Export(string id, string strtype)
        {
            ...
            var registeredfacultylist = (from rf in db.jntuh_registered_faculty
                                         join crf in db.jntuh_college_faculty_registered on rf.RegistrationNumber equals crf.RegistrationNumber
                                         join c in db.jntuh_college on crf.collegeId equals c.id
                                         join d in db.jntuh_department on crf.DepartmentId equals d.id
                                         //join s in db.jntuh_specialization on crf.SpecializationId equals s.id
                                         where (crf.collegeId == userCollegeID)
                                         select new
                                         {
                                             Collegecode = c.collegeCode,
                                             collegename = c.collegeName,
                                             RegistrationNumber = rf.RegistrationNumber,
                                             FacultyName = rf.FirstName + " " + (rf.MiddleName != null ? rf.MiddleName : "") + " " + rf.LastName,
                                             identifierfor = crf.IdentifiedFor,
                                             departmentName = d.departmentName,
                                             specializationId = crf.SpecializationId
                                             //specializationName = s.specializationName

                                         }).ToList();


            List<registeredfacultylist> registeredfaculty = new List<registeredfacultylist>();


            foreach (var faculty in registeredfacultylist)
            {
                registeredfacultylist obj = new registeredfacultylist();
                obj.Collegecode = faculty.Collegecode;
                obj.collegename = faculty.collegename;
                obj.RegistrationNumber = faculty.RegistrationNumber;
                obj.FacultyName = faculty.FacultyName.ToUpper();
                obj.identifierfor = faculty.identifierfor;
                obj.departmentName = faculty.departmentName;
                obj.specializationId = faculty.specializationId;
                //obj.specialization= db.jntuh_specialization.Where(s => s.id == faculty.specializationId);
                if (faculty.specializationId != null)
                    obj.specialization = db.jntuh_specialization.FirstOrDefault(s => s.id == faculty.specializationId).specializationName;

                registeredfaculty.Add(obj);
            }


            if (strtype == "Export" && registeredfaculty.Count() > 0)
            {
                Response.ClearContent();
                Response.Buffer = true;
                Response.AddHeader("content-disposition", "attachment; filename=" + college.collegeName + "(" + college.collegeCode + ")" + ".xls");
                Response.ContentType = "application/vnd.ms-excel";
                Response.ContentEncoding = System.Text.Encoding.Unicode;
                Response.BinaryWrite(System.Text.Encoding.Unicode.GetPreamble());
                return PartialView("~/Views/Faculty/Export.cshtml", registeredfaculty);
            }
            ...
            //ViewBag.Id = UAAAS.Models.Utilities.Encrypt("0", WebConfigurationManager.AppSettings["CryptoKey"]);
            //ViewBag.Id = 0;
            ViewBag.count = registeredfacultylist.Count();
            //if (Roles.IsUserInRole("Admin") == true)
            //{
            //  ViewBag.Admin = true;
            //}

            return View("Export", registeredfaculty);
        ...
        public ActionResult NonTeaching(string collegeId)
        {
            ...
            bool isPageEditable = db.jntuh_college_screens_assigned.Where(a => a.jntuh_college_screens.ScreenCode.Equals("NT") && a.CollegeId == userCollegeID).Select(a => a.IsEditable).FirstOrDefault();
        ...
        public ActionResult Technical(string collegeId)
        {
            ...
            bool isPageEditable = db.jntuh_college_screens_assigned.Where(a => a.jntuh_college_screens.ScreenCode.Equals("SF") && a.CollegeId == userCollegeID).Select(a => a.IsEditable).FirstOrDefault();
        ...
        public ActionResult Delete(CollegeFaculty faculty)
        {
            ...
            if (faculty.facultyId != 0 && faculty.RelivingDocument != null && faculty.id != 0)
            {
                ...
                if (faculty.AppointmentOrderDocument != null)
                {
                    ...
                    {
                        string fileName = DateTime.Now.ToString("yyyyMMdd-HHmmssffffff") + "-" +
                        regfacultydata.RegistrationNumber.Substring(0, 1) + "-" + regfacultydata.LastName.Trim().Substring(0, 1);
                        faculty.AppointmentOrderDocument.SaveAs(string.Format("{0}/{1}{2}", Server.MapPath(facultyappointmentletters),
                            fileName, ext));
                        faculty.ViewAppointmentOrderDocument = string.Format("{0}{1}", fileName, ext);
                        facultyexperiance.facultyJoiningOrder = faculty.ViewAppointmentOrderDocument;
                ...
                if (fToDelete != null)
                {
                    ...
                    if (jntuhFacultyTrackingData != null)
                    {
                        ...
                        objART.aadhaardocument = jntuhFacultyTrackingData.aadhaardocument;
                        objART.payscale = jntuhFacultyTrackingData.payscale;
                        objART.grosssalary = jntuhFacultyTrackingData.grosssalary;
            ...
            return RedirectToAction("Teaching", "Faculty", new { collegeId = UAAAS.Models.Utilities.EncryptString(userCollegeID.ToString(), WebConfigurationManager.AppSettings["CryptoKey"]).ToString() });
        }
        ...
        public ActionResult ViewAdhocFacultyDetails(string fid)
        {
            ...
            if (!string.IsNullOrEmpty(fid))
            {
                ...
                {
                    return RedirectToAction("ViewAdhocTeaching", "Faculty");
                }
            }
            else
            {
