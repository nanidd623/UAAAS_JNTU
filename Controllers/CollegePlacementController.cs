...
{
    [ErrorHandling]
    public class CollegePlacementController : BaseController
    {
        ...
        public ActionResult Index(string collegeId)
        {
            ...
            {
                return RedirectToAction("View", "CollegePlacement");
            }
            bool isPageEditable = db.jntuh_college_screens_assigned.Where(a => a.jntuh_college_screens.ScreenCode.Equals("PC") && a.CollegeId == userCollegeID).Select(a => a.IsEditable).FirstOrDefault();
