...
{
    public class OnlineAppealController : Controller
    {
        //
        // GET: /OnlineAppeal/

        private uaaasDBContext db = new uaaasDBContext();
        public ActionResult OnlineAppealFeeDetailsandPayment()
        {
            ...
            if (CollegeDetails != null)
            {
                ...
                if (userCollegeID > 0 && userCollegeID != null && currentDate >= EditFromDate && currentDate <= EditTODate)
                {
                    ...
                    var returnUrl = WebConfigurationManager.AppSettings["AppealReturnUrl"];
        ...
        [HttpPost]
        public ActionResult OnlineAppealFeeDetailsandPayment(string msg)
        {
